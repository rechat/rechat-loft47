...
export const BrokerageDealsProfileAccessesService = {
  retrieveBrokerageDealProfileAccesses: async (
    brokerage_id: string,
    deal_id: string
  ) => {
    try {
  ...
  retrieveBrokerageDealProfileAccess: async (
    brokerage_id: string,
    deal_id: string,
  ...
  createBrokerageDealProfileAccess: async (
    brokerage_id: string,
    deal_id: string,
  ...
  updateBrokerageDealProfileAccess: async (
    brokerage_id: string,
    deal_id: string,
    profile_access_id: string,
    profile_access: ProfileAccess
  ...
  deleteBrokerageDealProfileAccess: async (
    brokerage_id: string,
    deal_id: string,
    profile_access_id: string
  ) => {
